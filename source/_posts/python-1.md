...
#### Bug
+ 有时我们编写的程序会给我们报错误信息，虽然我们并不希望如此；
+ 我们应该像程序员一样思考，不惧怕错误信息，它们只是为了帮助我们找出问题，以便更正错误；
+ 若程序中确实出现了问题，你肯定更希望看到错误信息；
+ 有时遇到没有给出任何错误信息的`Bug`，才最是头痛的；
+ `Bug`：臭虫，程序员通常把讨厌的错误说成`Bug`；
